...
exports.default = (function (Options) {
    ...
    for (var Option_1 in Options) {
        if (Object.prototype.hasOwnProperty.call(Options, Option_1) &&
            Options[Option_1] === true) {
            Options[Option_1] = Index_js_1.default[Option_1];
        }
    }
    var _options = (0, files_pipe_1.Merge)(Index_js_1.default, Options);
    var paths = new Set();
    if (typeof _options["path"] !== "undefined") {
        if (_options["path"] instanceof Array ||
            _options["path"] instanceof Set) {
            for (var _i = 0, _a = _options["path"]; _i < _a.length; _i++) {
                var path = _a[_i];
                paths.add(path);
            }
        }
